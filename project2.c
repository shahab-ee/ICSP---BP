...
{
    int n;
    printf("hi soheil i am going to tell you your weight changes\n\n");
    printf("for how many days are you going to check?\n"); /*getting days of checking*/
    scanf("%d", &n);
    ...
    for (int i = 1; i <= n; i++)
    {
        ...
        do
        {
            printf("what is your choice for %dth day?", i);
            scanf("%d", &x);
    ...
    {
        printf("the result in %d days is LAGHAR\n", n);
    }
    else if (calories_sum > 100 * n)
    {
        printf("the result in %d days is CHAGH\n", n); /*conditions for showing the result*/
    }
    else
    {
        printf("the result in %d days is BEDOONE TAGHIR\n", n);
    }
